# Hi there, I'm Emmanuel Araiza 👋

### 🧪 QA Automation Engineer | Python · Postman · SQL · Selenium

Ingeniero enfocado en Aseguramiento de Calidad de Software (QA) con más de 10 años de trayectoria previa en operaciones aeronáuticas y tolerancia cero al error. Especializado en el ciclo STLC, pruebas de APIs REST, bases de datos y automatización web.

---

### 🛠️ Tech Stack & Herramientas

- **QA & Testing:** Manual Testing, Test Cases, Bug Reports, STLC, BVA, Equivalence Partitioning.
- **Backend & APIs:** Postman, REST APIs, JSON, SQL.
- **Automation:** Python, PyTest, Selenium WebDriver, Page Object Model (POM).
...
* Pruebas funcionales en emuladores móviles, validación de carritos/geolocalización y documentación técnica de fallos (`BUG-08`, `BUG-14`, `BUG-20`) en Jira.
